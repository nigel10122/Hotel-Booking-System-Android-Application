...
public class SharedPrefManagerManager {

    private static SharedPrefManagerManager mInstance;
    ...
    private SharedPrefManagerManager(Context context) {
        mCtx = context;

    }

    public static synchronized SharedPrefManagerManager getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new SharedPrefManagerManager(context);
        }
        return mInstance;
    }
